...
public final class FlowUtils {
    ...
    public static void followFlows(AbstractEngine engine, Execution execution, ProcessElementCommand c) throws ExecutionException {
        followFlows(engine, execution, c.getContext(), c.getProcessDefinitionId(), c.getElementId(), c.getGroupId(), c.isExclusive());
    }

    public static void followFlows(AbstractEngine engine, Execution execution, ProcessElementCommand c, String elementId) throws ExecutionException {
        followFlows(engine, execution, c.getContext(), c.getProcessDefinitionId(), elementId, c.getGroupId(), c.isExclusive());
    }

    public static void followFlows(AbstractEngine engine, Execution execution, ProcessElementCommand c, String groupId, boolean exclusive) throws ExecutionException {
        followFlows(engine, execution, c.getContext(), c.getProcessDefinitionId(), c.getElementId(), groupId, exclusive);
    }

    public static void followFlows(AbstractEngine engine, Execution execution, ExecutionContext context, String processDefinitionId, String elementId, String groupId, boolean exclusive) throws ExecutionException {
