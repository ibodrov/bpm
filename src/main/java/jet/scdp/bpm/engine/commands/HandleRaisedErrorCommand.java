...
public class HandleRaisedErrorCommand implements ExecutionCommand {
    ...
    @Override
    public Execution exec(AbstractEngine engine, Execution execution) throws ExecutionException {
        execution.pop();
    ...
    protected void followFlows(Execution s, ProcessDefinition pd, String elementId, ExecutionContext context) throws ExecutionException {
